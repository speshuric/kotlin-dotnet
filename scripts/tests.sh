...
TEST_IDS="00-int-add 02-expr 03-hello 04-loops 04-loops-spec"

# test_exists <id> — exit 0 если тест есть, 1 если нет.
test_exists() {
    case "$1" in
        00-int-add|02-expr|03-hello|04-loops|04-loops-spec) return 0 ;;
        *) return 1 ;;
    esac
}
...
test_kind() {
    case "$1" in
        ...
        03-hello|04-loops|04-loops-spec) echo "exe" ;;
        *) return 1 ;;
    esac
}

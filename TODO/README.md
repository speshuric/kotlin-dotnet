...
| 20 | Debug/release сборки: DebuggableAttribute + CLI config (L1), portable PDB (L2) | [K-01-debug-release-config.md](K-debug-builds/K-01-debug-release-config.md) | POST-10.9 (L1), POST-PoC (L2) | Phase 10.9, J-01 | WIP (L1 DONE) |
